...
@FragmentScope
public class UserFPersenter extends BasePresenter<UserContract.Model,UserContract.View> {
    ...
    @Inject
    public UserFPersenter(UserContract.Model model, UserContract.View rootView, RxErrorHandler handler
